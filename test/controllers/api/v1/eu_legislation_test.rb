...
class Api::V1::EuLegislationControllerTest < ActionController::TestCase
  def setup
    ...
    @opinion = FactoryBot.create(:eu_opinion, taxon_concept: @taxon_concept)
    ...
    @current_eu_regulation = FactoryBot.create(:eu_regulation, is_current: true)
    @historic_eu_regulation = FactoryBot.create(:eu_regulation, is_current: false)
